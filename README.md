...
This repository holds the files for my previous and current FPGA related projects. Included below is a section covering the goal and specifics for each project.
...
**GOAL**: To control the speed of a DC motor using pushbuttons to increase/decrease the speed in 15% increments (0-90%) and display its current speed via the 7-segment displays.  
**IMPLEMENTATION**:
...
-**FSM**: 
  -Frequency Division was used to slow the clock from 50 MHz down to 1 Hz so inputs register at 1 second intervals
